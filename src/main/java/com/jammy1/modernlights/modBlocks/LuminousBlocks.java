...
import static com.jammy1.modernlights.util.DefaultBlockSettings.defaultAndesiteFrameSettings;
import static com.jammy1.modernlights.util.DefaultBlockSettings.defaultLuminousBlockSettings;

public class LuminousBlocks {

    public static final Block ANDESITE_FRAME = Util.registerBlocks("andesite_frame", new AndesiteFrame(defaultAndesiteFrameSettings()));
    ...
    // Method to create luminous_blocks
    ...
    public static Block getLuminousBLockFull(LuminousColors color) {return LUMINOUS_FULL_BLOCKS.get(color);}
