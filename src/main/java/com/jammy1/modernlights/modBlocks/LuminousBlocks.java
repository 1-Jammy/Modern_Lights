...
public class LuminousBlocks {
    ...
    public static final Block ANDESITE_FRAME = Util.registerBlocks("andesite_frame", new AndesiteFrame(DefaultBlockSettings.DEFAULT_ANDESITE_FRAME_SETTINGS));
    ...
    private static Block createLuminousBlock(String name, boolean isFull, modernLights.LuminousColors color) {
        return Util.registerBlocks(name, isFull ? modernLights.fullInfo : null, new LuminousBlock(DefaultBlockSettings.defaultLuminousBlockSettings(color)));
    }
