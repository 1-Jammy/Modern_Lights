...
import static com.jammy1.modernlights.util.DefaultBlockSettings.DEFAULT_CEILING_LIGHT_SETTING;
import static com.jammy1.modernlights.util.DefaultBlockSettings.DEFAULT_MINI_LIGHT_SETTING;
...
public class LuminousLights {
    ...
    private static Block createBlock(String name, boolean isMiniLight) {
        return Util.registerBlocks(name, isMiniLight ? new MiniLightBlock(DEFAULT_MINI_LIGHT_SETTING) : new CeilingLightBlock(DEFAULT_CEILING_LIGHT_SETTING));
    }
