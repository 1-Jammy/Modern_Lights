...
import static com.jammy1.modernlights.util.DefaultBlockSettings.defaultLuminousVerticalSlabSettings;
...
public class LuminousVerticalSlabs {
    ...
    private static Block createLuminousSlab(String name, boolean isFull, modernLights.LuminousColors color) {
        return Util.registerBlocks(name, isFull ? modernLights.fullInfo : null, new LuminousVerticalSlabBlock(defaultLuminousVerticalSlabSettings(color)));
    }
