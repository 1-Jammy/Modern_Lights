...
public class LuminousVerticalSlabs {
    ...
    //TODO: Add recipe, models, blockstates, tags, loot tables for all the vertical slab blocks
    ...
    public static final Map<modernLights.LuminousColors, Block> LUMINOUS_VERTICAL_FULL_SLABS = new HashMap<>();
    ...
    static {
        ...
        for (modernLights.LuminousColors color : modernLights.LuminousColors.values()) {
            ...
            LUMINOUS_VERTICAL_FULL_SLABS.put(color, createLuminousSlab(blockName, true));
        }
    }
    ...
    public static Block getSmallPanelBLock(modernLights.LuminousColors color) {
        return LUMINOUS_VERTICAL_FULL_SLABS.get(color);
    }
