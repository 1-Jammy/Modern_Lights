...
import static com.jammy1.modernlights.modBlocks.LuminousBlocks.getLuminousBLock;
...
public class modernLights implements ModInitializer {
    ...
    public static final ItemGroup ITEM_GROUP = FabricItemGroup.builder(new Identifier(MOD_ID, "modernlights"))
            .icon(() -> new ItemStack(getLuminousBLock(WHITE)))
