...
public class DefaultBlockSettings {
    ...
    public static FabricBlockSettings defaultLuminousBlockSetting(LuminousColors color) {
    ...
    public static FabricBlockSettings defaultLuminousSlabSetting(LuminousColors color) {
        return Util.CREATE_BLOCK_SETTINGS(2.5f, 5.0f, LuminousSlabBlock.LIT, 15, false, color);
    }
    public static FabricBlockSettings defaultLuminousVerticalSlabSetting(LuminousColors color) {
        return Util.CREATE_BLOCK_SETTINGS(2.5f, 5.0f, LuminousSlabBlock.LIT, 15, false, color);
    }
    public static final FabricBlockSettings DEFAULT_CEILING_LIGHT_SETTING =
            Util.CREATE_BLOCK_SETTINGS(2.0f, 4.0f, MiniLightBlock.LIT, 10, true, null).noCollision();
    public static final FabricBlockSettings DEFAULT_MINI_LIGHT_SETTING =
            Util.CREATE_BLOCK_SETTINGS(2.0f, 4.0f, MiniLightBlock.LIT, 8, true, null).noCollision();
    public static final FabricBlockSettings DEFAULT_MINI_BLOCK_SETTING =
