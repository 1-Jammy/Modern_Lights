...
public class Util {
    ...
    private static Item registerBlockItem(String name, String info, Block block) {
        ...
        Item item = Registry.register(Registries.ITEM, new Identifier(modernLights.MOD_ID, name), new BlockItem(block, new FabricItemSettings()) {//adds freshly created item to the item group
